...
# title and icon on top
pygame.display.set_caption("Space invaders")
icon = pygame.image.load('spaceship-png-icon-9.png')
...
for i in range(num_of_enemies):
    ...
    enemyImg[i] = pygame.transform.scale(enemyImg[i], (70, 50))
...
bulletImg = pygame.transform.scale(bulletImg, (15, 20))
bulletX = 0
bulletY = 480
bulletY_change = 0
bulletY_change = 3
